...
\role{Steve Furlanetto}{University of California Los Angeles}{Dr. Furlanetto will develop theoretical frameworks for the project, with a particular emphasis on analytical methods, the connections between $21\,\textrm{cm}$ observations and other probes of reionization, and detailed numerical simulations.}
...
\role{Adam Lidz}{University of Pennsylvania}{Prof. Lidz will help develop the theoretical framework within which to analyze the reionization data, in particular methods to extract the non-Gaussian signatures of the reionization ``bubbles".}

%\role{Adrian Liu}{University of California Berkeley}{Dr. Liu will develop algorithms for power spectrum analysis.}

\role{Matthew McQuinn}{University of Washington}{Prof. McQuinn will help develop the theoretical framework within which to analyze reionization data, incorporating detailed models of the intergalactic-medium into full radiative transfer simulations and related analytical results.}
