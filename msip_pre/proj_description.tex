...
During these epochs, roughly 0.3$--$1~Gyr after the Big Bang, the first stars and black holes heated and reionized the Universe following cosmic recombination. % XXX check tense
...
($z\ge15$) and the Epoch of Reionization ($z\sim$15--6), a wealth of
...
\vspace{-8pt}
\noindent
\emph{HERA's incremental buildout will enable cutting edge science at each stage while mitigating project risk.}
...
instrumentalists at both the graduate and undergraduate levels, increase the
...
%XXX SF: Can we list how many here (if it's an impressive number)?  Also, why say "project plan" and not just "project"?
...
galaxy observations and can offer cross-correlations with both WFIRST near-IR surveys \citep{2009ApJ...690..252L} 
