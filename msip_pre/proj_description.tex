...
evolution of the intergalactic medium (IGM) during the 
Epoch of Reionization (EoR) and the preceding Dark Ages. 
Cosmic reionization corresponds to the epoch 
when the first stars and black holes reionize the 
...
spectrum, a second-generation HERA instrument to measure the EoR power spectrum in
...
astrophysical foregrounds that are $\sim$5 orders of magnitude brighter, as seen
...
\citep{pober_et_al2013,dillon_et_al2013b}, including suppression by more than 4
...
activities (supported by SKA-SA). Governance will be provided by an Executive Board made
