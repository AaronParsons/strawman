...
\title{HERA: Illuminating Our Early Universe} % ARP: this title?
...
% XXX update above with text from McQuinn
%The results, while encouraging, tend to over-predict photon production at later times where
%they may be compared with current observations.
...
%early universe \citep{pritchard_XXX} via their X-ray emission (see Figure \ref{fig:Xray}), 
...
% ARP: below, pasted paragraph about PAPER, for use in Miguel's text
