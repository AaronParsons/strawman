...
% XXX We agreed to take out 37 science. Now it is back. (I like bullets in intro, just drop 37.)
%Section 1 is better now. Second sentence of last paragraph still needs to be removed (non-sequiter)
...
foregrounds and lay the groundwork for detecting the EoR power
...
% XXX 37 is out.  make sure it's out everywhere
...
%Figure~\ref{fig:x_i_Xray}a shows the direct constraints on reionization using
%HERA~331/568
...
% XXX remove "Imaging regime" text
...
% XXX miguel: adding in polarization
