...
their results and the fact that reionization was a complex process (see Figure \ref{fig:x_i_Xray}).
...
\vspace{-0.25in}
\section{Broader Impacts: Training Instrumentalists and Developing African Scientists}
\label{BIsec}
...
\vspace{-0.25in}
\section{Benefits to the Community: Data Products}
